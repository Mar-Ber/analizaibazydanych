...
- AnalysisData - folder contain copy of original data file (0_DOLNOS╠üLA╠ĘSKIE.csv) and the fully cleaned and processed data files (age_data.xlsx, days_data.xlsx, gender_data.xlsx, name_data.xlsx and rate_data.xlsx),
